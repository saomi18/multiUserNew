...
<body class="overflow-x-hidden antialiased">
    ...
    <header class="relative z-50 w-full h-24">
        <div
            ...
            <a href="/" class="relative flex items-center inline-block h-5 h-full font-black leading-none">
                ...
                <span class="ml-3 text-xl text-gray-800">Medjet<span class="text-pink-500">.</span></span>
            </a>
            ...
            <nav id="nav"
                ...
                <a href="#pricing"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Info</a>
                <a href="galery"
                    class="mr-0 font-bold duration-100 md:mr-3 lg:mr-8 transition-color hover:text-indigo-600">Galery</a>
                <a href="cekot"
                    class="font-bold duration-100 transition-color hover:text-indigo-600">Booking</a>
            </nav>
    ...
    <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
        <div
            ...
            <div
                ...
                <h1 class="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">MEDJET KAKONG</h1>
                <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">Are you ready to start your
                    adventure and explore the nature?</p>
                <a href="cekot"
                    class="relative self-start inline-block w-auto px-8 py-4 mx-auto mt-0 text-base font-bold text-white bg-indigo-600 border-t border-gray-200 rounded-md shadow-xl sm:mt-1 fold-bold lg:mx-0">Booking Now!</a>
                <!-- Integrates with section -->
                <div class="flex-col hidden mt-12 sm:flex lg:mt-24">
                    <p class="mb-4 text-sm font-medium tracking-widest text-gray-500 uppercase">KUNJUNGI KAMI</p>
                    <div class="flex">
                        <svg class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600"
                            ...
                            <g stroke="none" stroke-width="1">
                                <g>
                                        <i class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600 fa fa-instagram fa-2x"></i>
                                </g>
                            </g>
                        </svg>
                        <svg class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600"
                            ...
                            <g stroke="none" stroke-width="1">
                            <g>
                                   <a href="https://web.facebook.com/help/2053403608222571/?helpref=uf_share"> <i class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600 fa fa-facebook fa-2x"></i></a>
                            </g>
                            </g>
                            <!-- https://web.facebook.com/help/2053403608222571/?helpref=uf_share -->
                        </svg>
                        <svg class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600"
                            ...
                            <g stroke="none" stroke-width="1">
                                <g transform="translate(-.157)">
                                        ...
                                        <a href="whatsapp://send?text=Hello&phone=+6285338562718"><i class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600 fa fa-whatsapp fa-2x"></i></a>
                        ...
                        <svg class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600"
                            ...
                            <g stroke="none" stroke-width="1">
                                <i class="h-8 mr-4 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600 fa fa-twitter fa-2x"></i>
                            </g>
                        </svg>
                    </div>
                </div>
    ...
    <div class="relative px-8 py-10 bg-white border-t border-gray-200 md:py-16 lg:py-24 xl:py-40 xl:px-0">
        ...
        <div id="pricing" class="container flex flex-col items-center h-full max-w-6xl mx-auto">
            <h2 class="my-5 text-base font-medium tracking-tight text-indigo-500 uppercase"></h2>
            <h3
                ...
                <div class="relative flex flex-col items-center block sm:flex-row">
                        ...
                        <div class="overflow-hidden text-black bg-white border-t border-gray-100 rounded-lg shadow-sm">
                            <!-- <div
                                class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                                 <h3 class="p-3 text-lg font-bold tracking-wide text-center uppercase">Spot<span
                                        class="ml-2 font-light">Foto</span></h3>
                                <h4
                             ...
                             <div class="flex flex-wrap px-6 mt-8">
                                <ul>
                                    <li class="flex items-center">
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">kampung wisata</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">wisata alam</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">danb banyak lagi</span>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div
                        ...
                        <div class="block max-w-sm px-8 mx-auto mt-5 text-sm text-left text-black sm:text-md lg:px-6">
                            <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Wisata<span
                                    class="ml-2 font-light">alam</span></h3>
                            <h4
                    ...
                    <div
                        ...
                        <!-- <div class="overflow-hidden text-black bg-white rounded-lg shadow-lg shadow-inner">
                            <div
                                ...
                                <h3 class="p-3 pb-1 text-lg font-bold tracking-wide text-center uppercase">Live<span
                                        class="ml-2 font-light">music</span></h3>
                                <h4
                                    class="flex items-center justify-center pb-6 text-4xl font-bold text-center text-gray-900">
                            ...
                            <div class="flex flex-wrap px-8 mt-8">
                                <ul>
                                    ...
                                    <li class="flex items-center">
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">live music</span>
                                    </li>
                                    <li class="flex items-center">
                                        <div class="p-2 text-green-500 rounded-full fill-current ">
                                            <svg class="w-6 h-6 align-middle" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <span class="ml-3 text-lg text-gray-700">camping area</span>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="flex flex-col w-full text-gray-700">
                    ...
                    <div class="flex justify-start pl-4 mt-2">
                        ...
                        <a class="flex items-center block text-gray-400 no-underline hover:text-gray-600"
                            ...
                            <i class="w-5 h-5 text-gray-500 duration-150 cursor-pointer fill-current transition-color hover:text-gray-600 fa fa-instagram"></i>
                        </a>
                    </div>
                </div>
            </div>
